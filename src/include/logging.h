...
#define LOG_DELAY(msg, delay) LogDelay(__FILE__, __LINE__, Part<bool, bool>() << msg, delay)
// #define LOG(msg, delay) Log(__FILE__, __LINE__, Part<bool, bool>() << msg, delay)
...
template<typename T>
void LogDelay(const char* file, int line, const T& msg, const size_t delay) NOINLINE_ATTRIBUTE
{
    std::cout << file << ":" << line << ": " << msg << std::endl;
