...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type Lows(LowsSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type Highs(HighsSEXP);
...
// L0LearnCV
Rcpp::List L0LearnCV(const SEXP& X, const Eigen::VectorXd& y, const std::string Loss, const std::string Penalty, const std::string Algorithm, const std::size_t NnzStopNum, const std::size_t G_ncols, const std::size_t G_nrows, const double Lambda2Max, const double Lambda2Min, const bool PartialSort, const std::size_t MaxIters, const double Tol, const bool ActiveSet, const std::size_t ActiveSetNum, const std::size_t MaxNumSwaps, const double ScaleDownFactor, std::size_t ScreenSize, const bool LambdaU, const std::vector< std::vector<double> > Lambdas, const std::size_t nfolds, const double seed, const std::size_t ExcludeFirstK, const bool Intercept, const Eigen::VectorXd& Lows, const Eigen::VectorXd& Highs);
...
Eigen::MatrixXd R_matrix_vector_schur_product_dense(const Eigen::MatrixXd& mat, const Eigen::VectorXd& u);
...
Eigen::SparseMatrix<double> R_matrix_vector_schur_product_sparse(const Eigen::SparseMatrix<double>& mat, const Eigen::VectorXd& u);
...
Eigen::MatrixXd R_matrix_vector_divide_dense(const Eigen::MatrixXd& mat, const Eigen::VectorXd& u);
...
Eigen::SparseMatrix<double> R_matrix_vector_divide_sparse(const Eigen::SparseMatrix<double>& mat, const Eigen::VectorXd& u);
...
double R_matrix_column_dot_dense(const Eigen::MatrixXd& mat, int col, const Eigen::VectorXd u);
...
double R_matrix_column_dot_sparse(const Eigen::SparseMatrix<double>& mat, int col, const Eigen::VectorXd u);
